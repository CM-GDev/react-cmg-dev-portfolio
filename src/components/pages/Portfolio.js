...
const deployHref4 = "https://cm-gdev.github.io/Server-SideAPIs_Weather-Dashboard/";
...
const description4 = "In this homework assignment, I implemented the use of a third-party API for the first time. As the name suggests, the webpage retrieves and displays weather forcast for any US city searched by the user. The webpage also has a search history area for the user to use.";
