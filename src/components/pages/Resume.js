...
import ResumePDF from '../../img/ResumeWebDev2022CB.pdf';
...
export default function Resume() {
  return (
    <main className='container'>
      ...
      <a className="btn waves-effect waves-light blue darken-1" href={ResumePDF} target="blank">Download Resume<i className='material-icons right'>description</i></a>
