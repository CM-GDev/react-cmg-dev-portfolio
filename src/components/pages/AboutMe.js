...
export default function AboutMe() {
  return (
    <main className='container'>
      ...
      <p>
      I'm a full stack web developer applying over ten years of experience as a mechanical engineer in the Aerospace and Defense industries to build robust and efficient web applications. I'm currently enrolled in a full stack web developer course through the University of Washington and am developing skills and applying industry best practices in JavaScript, HTML, and CSS to develop and support responsive web designs.</p>
